...
//     private toggleActionsBar = handleBooleanChange((showActionsBar) => setState({ showActionsBar }));

//     private toggleSelection = handleBooleanChange((closeOnSelection) => setState({ closeOnSelection }));

//     private toggleShortcuts = handleBooleanChange((shortcuts) => setState({ shortcuts }));

//     private toggleDisabled = handleBooleanChange((disabled) => setState({ disabled }));

//     private toggleShowTimezoneSelect = handleBooleanChange((showTimezoneSelect) =>
//         setState({ showTimezoneSelect }),
//     );

//     private toggleDisableTimezoneSelect = handleBooleanChange((disableTimezoneSelect) =>
//         setState({ disableTimezoneSelect }),
//     );

//     private toggleFill = handleBooleanChange((fill) => setState({ fill }));

//     private toggleReverseMenus = handleBooleanChange((reverse) => setState({ reverseMonthAndYearMenus: reverse }));

//     private toggleRightElement = handleBooleanChange((showRightElement) => setState({ showRightElement }));

//     private toggleTimePickerArrows = handleBooleanChange((showTimePickerArrows) =>
//         setState({ showTimePickerArrows }),
//     );

//     private toggleUseAmPm = handleBooleanChange((useAmPm) => setState({ useAmPm }));

//     private handleTimePrecisionChange = handleValueChange((timePrecision: TimePrecision | 'none') =>
//         setState({ timePrecision: timePrecision === 'none' ? undefined : timePrecision }),
//     );

//     public render() {
//         const { date, format, showRightElement, showTimePickerArrows, useAmPm, ...spreadProps } = state;
...
//                     <Switch label="Close on selection" checked={closeOnSelection} onChange={toggleSelection} />
//                 </PropCodeTooltip>
...
//                 <H5>Appearance props</H5>
//                 <Switch label="Disabled" checked={disabled} onChange={toggleDisabled} />
//                 <Switch label="Fill" checked={fill} onChange={toggleFill} />
//                 <PropCodeTooltip snippet={`reverseMonthAndYearMenus={${reverse.toString()}}`}>
//                     <Switch label="Reverse month and year menus" checked={reverse} onChange={toggleReverseMenus} />
//                 </PropCodeTooltip>
//                 <PropCodeTooltip
...
//                     />
//                 </PropCodeTooltip>
//                 <Switch label="Show right element" checked={showRightElement} onChange={toggleRightElement} />
//                 <DateFnsFormatSelector format={format} onChange={handleFormatChange} />
